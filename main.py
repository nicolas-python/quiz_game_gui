...
class quiz_game:
    def __init__(self,root):
        ...
        self.questions = [
            #Grundfunktionen
            ("Was macht int()?",["Ganzzahl","Text","Kommas","True/false"],"Ganzzahl","Wandelt einen Wert in eine Ganzzahl um, dabei werden Nachkommastellen entfernt (z. B. 5.7 wird zu 5)"),
            ("Was macht str()?",["Zahl","Text","Komma","Liste"],"Text","Wandelt einen Wert in einen Text (String) um, z. B. wird 5 zu '5'"),
            ("Was ist bool?",["Text","True/False","Zahl","Liste"],"True/False","Ein Datentyp, der nur zwei Werte kennt: True (wahr) oder False (falsch)"),
            ...
            ("Was ist print()?",["Ausgabe","Eingabe","Datei","Liste"],"Ausgabe","Gibt Werte oder Text im Terminal bzw. auf dem Bildschirm aus"),
            ("Was ist input()?",["Berechnung","Eingabe","Ausgabe","Datai"],"Eingabe","Fordert den Benutzer zur Eingabe auf und gibt den eingegebenen Text als String zurück"),
            #funktionen
            ...
            ("Was ist Parameter?",["Variable", "Liste", "Funktion", "Wert"],"Wert","Ein Wert, der einer Funktion beim Aufruf übergeben wird"),
            #Listen & Text
            ...
            ("Was macht split()?",["Trennen", "Verbinden", "Löschen","Sortieren"],"Trennen","Teilt einen Text in mehrere Teile und gibt diese als Liste zurück"),
            ("Was macht .strip()?",["Teilen", "Text kürzen", "Zählen","Leerzeichen entfernen"],"Leerzeichen entfernen","Entfernt Leerzeichen oder bestimmte Zeichen am Anfang und Ende eines Textes(\\n wäre Zeilenumbruch)"),
            ("Was macht .lower()?",["klein", "groß", "löschen", "trennen"],"klein","Wandelt alle Buchstaben eines Textes in Kleinbuchstaben um"),
            ("Was macht .upper()?",["anhängen", "klein", "groß", "löschen"],"groß","Wandelt alle Buchstaben eines Textes in Großbuchstaben um"),
            #Listen Funktionen
            ("Was macht append()?",["Hinzufügen", "Löschen", "Sortieren", "Teilen"],"Hinzufügen","Fügt ein neues Element am Ende einer Liste hinzu"),
            ("Was macht remove()?",["Sortieren", "Hinzufügen", "Löschen", "Kopieren"],"Löschen","Entfernt ein bestimmtes Element aus einer Liste"),
            ("Was macht pop()?",["Letztes", "Erstes", "Alles", "Sortieren"],"Letztes","Entfernt das letzte Element aus einer Liste und gibt es zurück"),
            ("Was macht sort()?",["Mischen", "Sortieren", "Löschen", "Kopieren"],"Sortieren","Sortiert die Elemente einer Liste in aufsteigender Reihenfolge"),
            ("Was ist []?",["Liste", "Text", "Zahl", "Funktion"],"Liste","Erstellt eine Liste, in der mehrere Werte gespeichert werden können"),
            ("Was macht index?",["Position", "Wert", "Sortieren", "Zählen"],"Position","Gibt die Position (Index) eines bestimmten Elements in einer Liste zurück"),
            ("Was macht in?",["Addieren", "Vergleich", "Sortieren", "Enthalten"],"Enthalten","Prüft, ob ein bestimmter Wert in einer Liste oder einem Text enthalten ist"),
            #Schleifen / range
            ("Was macht for?",["Funktion", "Bedingung", "Schleife", "Variable"],"Schleife","Wiederholt einen Codeblock für jedes Element einer Sequenz oder eine bestimmte Anzahl von Malen"),
            ("Was macht while?",["Vergleich", "Wiederholung", "Funktion", "Import"],"Wiederholung","Wiederholt einen Codeblock so lange, wie eine Bedingung wahr ist"),
            ("Was macht break?",["Stop", "Weiter", "Start", "Vergleich"],"Stop","Beendet eine Schleife sofort, auch wenn die Bedingung noch wahr ist"),
            ("Was macht continue?",["Reset", "Stop", "Weiter", "Ende"],"Weiter","Überspringt den aktuellen Durchlauf einer Schleife und fährt mit dem nächsten fort"),
            ...
            #Bedingungen
            ("Was macht if?",["Bedingung", "Schleife", "Funktion", "Variable"],"Bedingung","Prüft, ob eine Bedingung wahr ist und führt dann den entsprechenden Code aus"),
            ("Was macht else?",["Start", "Wenn", "Stop", "Sonst"],"Sonst","Führt Code aus, wenn die Bedingung von if nicht erfüllt ist"),
            ("Was macht elif?",["Sonst-wenn", "Immer", "Stop", "Start"],"Sonst-wenn","Prüft eine weitere Bedingung, wenn die vorherige if-Bedingung falsch war"),
            ("Was macht ==?",["Kleiner", "Ungleich", "Vergleich", "Größer"],"Vergleich","Vergleicht zwei Werte und prüft, ob sie gleich sind"),
            ("Was macht !=?",["Zuweisung", "Gleich", "Vergleich", "Ungleich"],"Ungleich","Vergleicht zwei Werte und prüft, ob sie ungleich sind"),
            ("Was macht isalpha()?",["Leerzeichen", "Zahlen", "Buchstaben", "Symbole"],"Buchstaben","Prüft, ob ein Text nur aus Buchstaben besteht"),
            ("Was macht isdigit()?",["Zahlen", "Buchstaben", "Text", "Liste"],"Zahlen","Prüft, ob ein Text nur aus Ziffern besteht"),
            ("Was macht < ?",["gleich", "größer", "kleiner", "ungleich"],"kleiner","Prüft, ob ein Wert kleiner als ein anderer ist"),
            ("Was macht > ?",["größer", "kleiner", "gleich", "ungleich"],"größer","Prüft, ob ein Wert größer als ein anderer ist"),
            #Rechnen/Operatoren
            ("Was macht +?",["Minus", "Mal", "Plus", "Rest"],"Plus","Addiert zwei Werte miteinander"),
            ("Was macht -?",["Plus", "Minus", "Mal", "Geteilt"],"Minus","Subtrahiert einen Wert von einem anderen"),
            ("Was macht *?",["Geteilt", "Mal", "Plus", "Rest"],"Mal","Multipliziert zwei Werte miteinander"),
            ("Was macht /?",["Rest", "Mal", "Plus", "Geteilt"],"Geteilt","Teilt einen Wert durch einen anderen"),
            ("Was macht %?",["Rest", "Division", "Multiplikation", "Addition"], "Rest","Gibt den Rest einer Division zurück"),
            #GUI (tkinter)
            ...
            ("Was macht pack()?",["Sortieren", "Raster", "Position", "Stapel"],"Stapel","Ordnet GUI-Elemente untereinander oder nebeneinander an"),
            ("Was macht grid()?",["Stapel", "Raster", "Liste", "Position"],"Raster","Ordnet GUI-Elemente in einer Tabellenstruktur mit Zeilen und Spalten an"),
            ("Was macht place()?",["Position", "Raster", "Stapel", "Liste"],"Position","Platziert GUI-Elemente an einer festen Position im Fenster"),
            #Entry / GUI Text
            ("Was macht entry.get()?",["Schreiben", "Lesen", "Löschen", "Sortieren"],"Lesen","Liest den aktuellen Text aus einem Eingabefeld aus"),
            ("Was macht insert()?",["Teilen","Löschen","Vergleichen","Schreiben"],"Schreiben","Fügt Text an einer bestimmten Position in ein Feld ein"),
            ("Was macht delete()?",["Ende","Trennen","Löschen","Lesen"],"Löschen","Löscht Text aus einem Eingabefeld"),
            ("Was ist entry?",["Feld","Sortieren","Lesen","Stapeln"],"Feld","Ein Eingabefeld in einer GUI, in das der Benutzer Text eingeben kann")
        ]
